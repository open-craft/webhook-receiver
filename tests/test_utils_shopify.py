...
class RecordOrderTest(ShopifyTestCase):
    ...
    def test_record_order(self):
        ...
        # that in the payload
        order1, created1 = record_order(self.webhook_data, Order.ACTION_ENROLL)
        self.assertTrue(created1)
        self.assertEqual(order1.order_id, self.json_payload['id'])
        # Try to create the order again, make sure we get a reference
        # instead
        order2, created2 = record_order(self.webhook_data, Order.ACTION_ENROLL)
...
class ProcessOrderTest(ShopifyTestCase):
    ...
    def test_valid_order(self):
        order, created = record_order(self.webhook_data, Order.ACTION_ENROLL)
    ...
    def test_invalid_sku(self):
        ...
        order, created = record_order(fixup_webhook_data, Order.ACTION_ENROLL)
